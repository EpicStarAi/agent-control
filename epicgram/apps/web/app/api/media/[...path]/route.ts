...
// Additive proxy for Media connectors (/media/*). Forwards to the EPIC GRAM API backend.
// no-store: generation results must never be cached. Keys live server-side only (never here).
