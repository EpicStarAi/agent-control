...
export const PACKS: RenderPack[] = [
  { id: "profile", name: "Профиль-пак", description: "Чистые профильные фото", engine: "grok_imagine_ui",
    scenes: ["professional_headshot", "clean_avatar", "full_body_neutral", "studio_portrait", "social_profile_photo"] },
  { id: "influencer", name: "Инфлюенсер-пак", description: "Лайфстайл-контент", engine: "grok_imagine_ui",
    scenes: ["lifestyle_cafe", "street_style", "mirror_selfie_style", "rooftop_evening", "casual_day_out"] },
  { id: "business", name: "Бизнес-пак", description: "Деловые портреты", engine: "grok_imagine_ui",
    scenes: ["executive_headshot", "office_portrait", "conference_speaker", "premium_lobby", "linkedin_profile"] },
  { id: "cyber", name: "Кибер-пак", description: "Neon / AI-оператор", engine: "grok_imagine_ui", preferredProvider: "mock_grok_imagine",
    scenes: ["neon_city", "ai_operator_room", "holographic_dashboard", "dark_cyber_portrait", "epicgram_operator"] },
  { id: "travel", name: "Трэвел-пак", description: "Путешествия", engine: "grok_imagine_ui",
    scenes: ["airport_lounge", "hotel_lobby", "paris_street", "dubai_skyline", "beach_resort"] },
  { id: "promo", name: "Промо-пак", description: "Промо / обложки", engine: "grok_imagine_ui",
    scenes: ["telegram_banner", "youtube_thumbnail", "tiktok_cover", "product_poster", "launch_announcement"] },
  { id: "story", name: "Стори-пак", description: "Сюжетные сцены", engine: "grok_imagine_ui",
...
export const TEMPLATE_CARDS: TemplateCard[] = [
  tcard("emotion", "neutral", "Нейтрально", "Expression: calm neutral, relaxed face"),
  tcard("emotion", "smile", "Улыбка", "Expression: warm natural smile"),
  tcard("emotion", "serious", "Серьёзно", "Expression: focused serious look"),
  tcard("emotion", "surprised", "Удивление", "Expression: mild genuine surprise"),
  tcard("emotion", "confident", "Уверенно", "Expression: calm confident gaze"),
  tcard("pose", "portrait", "Портрет", "Pose: head-and-shoulders portrait"),
  tcard("pose", "half_body", "Поясной план", "Pose: half-body framing"),
  tcard("pose", "full_body", "В полный рост", "Pose: full-body standing"),
  tcard("pose", "seated", "Сидя", "Pose: seated, natural posture"),
  tcard("pose", "walking", "В движении", "Pose: walking mid-step"),
  tcard("outfit", "casual", "Casual", "Outfit: casual everyday clothing"),
  tcard("outfit", "business", "Деловой", "Outfit: business formal attire"),
  tcard("outfit", "cyber", "Кибер", "Outfit: cyber / techwear styling"),
  tcard("outfit", "travel", "Тревел", "Outfit: travel-ready casual"),
  tcard("outfit", "creator", "Крейтор", "Outfit: creator / streetwear style"),
  tcard("background", "studio", "Студия", "Background: clean studio backdrop"),
  tcard("background", "city", "Город", "Background: urban city street"),
  tcard("background", "office", "Офис", "Background: modern office interior"),
  tcard("background", "neon", "Неон", "Background: neon-lit environment"),
  tcard("background", "outdoor", "На улице", "Background: natural outdoor setting"),
  tcard("camera", "close_up", "Крупный план", "Camera: close-up shot"),
  tcard("camera", "medium_shot", "Средний план", "Camera: medium shot"),
  tcard("camera", "wide_shot", "Общий план", "Camera: wide shot"),
  tcard("camera", "cinematic", "Кинематографично", "Camera: cinematic composition"),
  tcard("platform", "telegram_post", "Пост Telegram", "Format: Telegram post framing, 4:5"),
  tcard("platform", "avatar_portrait", "Портрет-аватар", "Format: square avatar portrait, 1:1"),
  tcard("platform", "youtube_shorts_cover", "Обложка YouTube Shorts", "Format: YouTube Shorts cover, 9:16"),
  tcard("platform", "instagram_reel_cover", "Обложка Instagram Reel", "Format: Instagram Reel cover, 9:16"),
  tcard("platform", "tiktok_cover", "Обложка TikTok", "Format: TikTok cover, 9:16"),
];
