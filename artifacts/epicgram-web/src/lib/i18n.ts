...
const en: Dict = {
  ...
  "sb.commandsHint": "E.g.: open private chats, open chat NOVIKOVA, show chat context, send status.",
  "sb.notFoundChat": "Could not find that chat. Pick it manually or type the exact name.",
  "sb.clarifyChatName": "Which chat should I open? Type the exact name.",
  "sb.help": "Available commands: open private chats / open chat list / open current chat / open chat <name> / show send status / show chat context / help.",
  "sb.running": "Running",
  // nav / sections
...
const ru: Dict = {
  ...
  "sb.commandsHint": "Например: открой личку, открой чат NOVIKOVA, покажи контекст чата, статус отправки.",
  "sb.notFoundChat": "Не нашёл чат. Выбери его вручную или напиши точное имя.",
  "sb.clarifyChatName": "Какой чат открыть? Напиши точное имя.",
  "sb.help": "Доступные команды: открой личку / открой список чатов / открой текущий чат / открой чат <имя> / статус отправки / контекст чата / помощь.",
  "sb.running": "Выполняю",
...
const ua: Dict = {
  ...
  "sb.commandsHint": "Наприклад: відкрий особисті повідомлення, відкрий чат NOVIKOVA, покажи контекст чату, статус відправки.",
  "sb.notFoundChat": "Не знайшов чат. Обери його вручну або напиши точну назву.",
  "sb.clarifyChatName": "Який чат відкрити? Напиши точну назву.",
  "sb.help": "Доступні команди: відкрий особисті повідомлення / відкрий список чатів / відкрий поточний чат / відкрий чат <ім'я> / статус відправки / контекст чату / допомога.",
  "sb.running": "Виконую",
