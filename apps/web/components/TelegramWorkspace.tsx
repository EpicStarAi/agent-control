...
export function TelegramWorkspace({ ctx, slotId, focusKind, focusId, onClose, onOpenAgent }: {
  ctx: Ctx; slotId?: string; focusKind?: string; focusId?: string; onClose: () => void; onOpenAgent?: (id: string) => void;
}) {
