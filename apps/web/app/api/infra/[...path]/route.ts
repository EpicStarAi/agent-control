...
// Additive proxy for PHASE T Live Infrastructure Bridge (/infra/*).
// Read-only introspection + guarded local control. no-store: live metrics must never be cached.
