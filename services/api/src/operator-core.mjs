...
export function getOperatorConfig() {
  return {
    ...
    primaryModel: process.env.OPERATOR_PRIMARY_MODEL || process.env.EPICGRAM_OPENAI_MODEL || "qwen2.5-coder:7b",
    fallbackModel: process.env.OPERATOR_FALLBACK_MODEL || "gemma2:9b",
    ...
    timeoutMs: Number(process.env.OPERATOR_MODEL_TIMEOUT_MS || 3000),
